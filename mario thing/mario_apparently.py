...
class Game:
    def __init__(self):
        ...
        for x in range(0, 5):
            for y in range(0, 5):
                self.canvas.create_image(x * w, y * h, anchor='nw', image=self.bg)
        self.sprites = []
        self.running = True
...
class PlatformSprite(Sprite):
    def __init__(self, game, photo_image, x, y, width, height):
        ...
        self.image = game.canvas.create_image(x, y, anchor='nw', image=self.photo_image)
...
class StickFigureSprite(Sprite):
    ...
    def coords(self):
        ...
        self.coordinates.x = xy[0]
        self.coordinates.y = xy[1]
        self.coordinates.y2 = xy[0] + 27
        self.coordinates.x2 = xy[1] + 30
        return self.coordinates
